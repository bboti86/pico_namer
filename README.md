...
- **[PySDL2](https://github.com/py-sdl/py-sdl2)**: Powering the handheld user interface.
- **[Spruce OS](https://spruceui.github.io/#) Team**: For the wonderful handheld environment.
